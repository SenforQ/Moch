...
/*: "&sr=6" :*/
fileprivate let mainVisibleId:String = "style style start self type&sr=6"
...
enum ConstraintScalarLiteral: String, CaseIterable {
...
enum AddBeautyMirrorPath: String {
...
class ViewProduceThen: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func nearOfType(urlType: AddBeautyMirrorPath) -> String {
        //: var url = NowInfoThen.share.appConfigMode.urlH5Domain
        var url = NowInfoThen.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(NowInfoThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : NowInfoThen.share.appUserConfigMode.fullRechargePage)
            url.append(NowInfoThen.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : NowInfoThen.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(NowInfoThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : NowInfoThen.share.appUserConfigMode.halfRechargePage)
            url.append(NowInfoThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : NowInfoThen.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = NowInfoThen.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = NowInfoThen.share.appUserConfigMode.halfRechargePage.appending((String(mainVisibleId.suffix(5))))
            //: url.append(NowInfoThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(NowInfoThen.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:
