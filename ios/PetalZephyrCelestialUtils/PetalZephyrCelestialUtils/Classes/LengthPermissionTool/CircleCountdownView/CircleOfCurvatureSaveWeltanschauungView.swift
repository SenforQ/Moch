...
fileprivate let noti_curvePath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]
...
// __CLOSE_PRINT__
//
//  CircleOfCurvatureSaveWeltanschauungView.swift
//  AbroadTalking
//
...
let app_matchMessage = 3.0

//: class CircleCountdownView: UIView {
class CircleOfCurvatureSaveWeltanschauungView: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.heatherMixture() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_curvePath.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.photographicEquipment(type: .Semibold, fontSize: 19)
    ...
    private lazy var bPath: UIBezierPath = {
        ...
        let rect = CGRect(x: app_matchMessage / 2,
                          //: y: CIRCLECOUNTDOWNLINE_W/2,
                          y: app_matchMessage / 2,
                          //: width: self.frame.width-CIRCLECOUNTDOWNLINE_W,
                          width: self.frame.width - app_matchMessage,
                          //: height: self.frame.height-CIRCLECOUNTDOWNLINE_W)
                          height: self.frame.height - app_matchMessage)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.heatherMixture().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = app_matchMessage
...
extension CircleOfCurvatureSaveWeltanschauungView {
    /// 创建UI
    //: private func createUI() {
    private func straddleUi() {
    ...
    func everyAppear(totalTime: Int, currTime: Int) {
