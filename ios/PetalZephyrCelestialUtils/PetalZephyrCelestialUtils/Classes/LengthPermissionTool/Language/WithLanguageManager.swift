...
@objcMembers open class WithLanguageManager: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = WithLanguageManager()
    //: private(set) var currLanguage: String = LineThen.getSystemLangCode()
    private(set) var currLanguage: String = LineThen.can()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func nameLanguage(_ language: String) {
...
extension String {
    ...
    public func toAppear(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let language = WithLanguageManager.shared.currLanguage
        //: let languageFolder = SVGAEffectTool.default.languagePath
        let languageFolder = ProduceActionReactiveCompatible.default.languagePath
