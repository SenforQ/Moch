...
fileprivate let notiMeText:[Character] = ["b","t","n","_","m","e","_","b","a","c","k","_","c"]
fileprivate let data_completeKey:String = "onsessioninue"

/*: "init(coder:) has not been implemented" :*/
fileprivate let dataHeadId:[UInt8] = [0xf9,0xfe,0xf9,0x4,0xb8,0xf3,0xff,0xf4,0xf5,0x2,0xca,0xb9,0xb0,0xf8,0xf1,0x3,0xb0,0xfe,0xff,0x4,0xb0,0xf2,0xf5,0xf5,0xfe,0xb0,0xf9,0xfd,0x0,0xfc,0xf5,0xfd,0xf5,0xfe,0x4,0xf5,0xf4]

fileprivate func vacateContent(data num: UInt8) -> UInt8 {
...
// __CLOSE_PRINT__
//
//  StatuteTextReactiveCompatible.swift
//  AbroadTalking
//
...
class StatuteTextReactiveCompatible: UIView {
    ...
    private lazy var leftBtn: UIButton = {
        ...
        leftBtn.addTarget(self, action: #selector(moveMessage), for: .touchUpInside)
        //: return leftBtn
        return leftBtn
        //: }()
    }()
    ...
    private lazy var rightBtn: UIButton = {
        ...
        rightBtn.addTarget(self, action: #selector(serration), for: .touchUpInside)
        //: return rightBtn
        return rightBtn
        //: }()
    }()
         ...
         config: MagnitudeAlertConfig)
    {
        ...
        if leftBtnTitle == nil && leftBtnAttributedTitle == nil {
            ...
            alertConfig.rightBackgroundImage = (String(notiMeText) + data_completeKey.replacingOccurrences(of: "session", with: "t"))
        }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataHeadId.map{vacateContent(data: $0)}, encoding: .utf8)!)
    }

    //: func changeRightBtn(title: String, isTouch: Bool) {
    func addColor(title: String, isTouch: Bool) {
