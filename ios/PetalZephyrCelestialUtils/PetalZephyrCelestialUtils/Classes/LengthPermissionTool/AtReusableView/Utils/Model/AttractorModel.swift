...
//: @objcMembers public class AttractorModel: JSONModel {
@objcMembers public class AttractorModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = PracticeInsetTarget.Face
...
//: @objc extension AttractorModel {
@objc extension AttractorModel {
    //: func initWith(suiteType: BeautyItemType)-> AttractorModel {
    func renderView(suiteType: PracticeInsetTarget) -> AttractorModel {
        //: let model = AttractorModel.init()
        let model = AttractorModel()
        //: model.beautySuite = suiteType
        model.beautySuite = suiteType
        //: model.resetBeautySuiteValueFor()
        model.searchUpEnable()
        //: return model
        return model
    }
