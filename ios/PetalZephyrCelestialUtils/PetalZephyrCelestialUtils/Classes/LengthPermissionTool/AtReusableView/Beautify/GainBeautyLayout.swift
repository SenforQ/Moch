...
class GainBeautyLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        layoutContentSize = CGSize(width: Int(constExplainViewMsg) * page, height: 2*GiftItemHeight)
    }
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let x = page * Int(constExplainViewMsg) + pageCol * (itemWidth )
