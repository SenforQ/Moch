...
open class NumberDetailContentView: UITextView {
    ...
    @IBInspectable open var placeholderColor: UIColor = NumberDetailContentView.Constants.defaultiOSPlaceholderColor {
        //: didSet {
        didSet {
