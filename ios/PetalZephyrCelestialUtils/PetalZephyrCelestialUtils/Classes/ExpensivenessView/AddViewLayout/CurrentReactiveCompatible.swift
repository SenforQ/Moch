...
fileprivate let constHiddenMsg:[UInt8] = [0xe6,0xe1,0xe6,0xfb,0xa7,0xec,0xe0,0xeb,0xea,0xfd,0xb5,0xa6,0xaf,0xe7,0xee,0xfc,0xaf,0xe1,0xe0,0xfb,0xaf,0xed,0xea,0xea,0xe1,0xaf,0xe6,0xe2,0xff,0xe3,0xea,0xe2,0xea,0xe1,0xfb,0xea,0xeb]

/*: "UITableViewCellContentView" :*/
fileprivate let kCenterData:String = "var model titleUITable"
fileprivate let kUserMakeViewMsg:[Character] = ["V","i","e","w","C","e","l","l","C","o","n","t","e","n","t","V","i","e","w"]
...
class CurrentReactiveCompatible: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(largeView))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constHiddenMsg.map{$0^143}, encoding: .utf8)!)
    }
    ...
    func appView() {
        ...
        self.buttonController()?.view.endEditing(true)
...
extension CurrentReactiveCompatible: UIGestureRecognizerDelegate {
    ...
    func gestureRecognizer(_: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        if classStr == (String(kCenterData.suffix(7)) + String(kUserMakeViewMsg)) {
            //: return false
            return false
            //: }else {
        } else {
