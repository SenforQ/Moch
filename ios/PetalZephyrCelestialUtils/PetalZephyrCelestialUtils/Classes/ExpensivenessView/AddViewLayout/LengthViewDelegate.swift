...
fileprivate let dataInfoMessage:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#292929" :*/
fileprivate let userPathValue:String = "#2mainmain9"

/*: "9999999" :*/
fileprivate let app_addMessage:[Character] = ["9","9","9","9","9","9","9"]

/*: "icon_coin" :*/
fileprivate let dataSharedBurnForName:[Character] = ["i","c","o","n","_","c","o","i","n"]

/*: "icon_gift_more_arrow" :*/
fileprivate let const_userToUrl:String = "resent"
fileprivate let notiMakeData:String = "index in duringcon_g"
fileprivate let dataSumBottomName:String = "re_astring request define single situation"

/*: "Hot" :*/
fileprivate let noti_fieldStr:String = "Hotpush beauty"

/*: "VIP" :*/
fileprivate let show_actualUrl:String = "makeIP"

/*: "Bags" :*/
fileprivate let notiBoxUrl:String = "Bagsfor to"

/*: "icon_gift_num_arrow" :*/
fileprivate let app_sizeMsg:[Character] = ["i","c","o","n","_","g","i","f","t","_","n","u","m","_","a","r"]
fileprivate let show_howStr:String = "roprompt"

/*: "Send" :*/
fileprivate let dataViewEqualMakeMsg:[Character] = ["S","e","n","d"]

/*: "nav_back_black_nor" :*/
fileprivate let mainNoticeId:[Character] = ["n","a","v","_","b","a","c","k","_"]
fileprivate let mainRestoreName:[Character] = ["b","l","a","c","k","_","n","o","r"]

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let userFrameMsg:[UInt8] = [0x77,0x8b,0x88,0x43,0x91,0x98,0x90,0x85,0x88,0x95,0x43,0x92,0x89,0x43,0x8a,0x8c,0x89,0x97,0x96,0x43,0x86,0x84,0x91,0x91,0x92,0x97,0x43,0x85,0x88,0x43,0x8f,0x88,0x96,0x96,0x43,0x97,0x8b,0x84,0x91,0x43,0x54]

fileprivate func stochasticProcess(cell num: UInt8) -> UInt8 {
...
fileprivate let show_titleData:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e","c","t"," ","a"," ","g","i","f","t"]

/*: "Please select an object" :*/
fileprivate let constStatusName:String = "Pleaslabel index sex bottom"
fileprivate let user_gesturePath:String = "ect afirst true self label end"
fileprivate let data_greetKey:String = "ECT"

/*: "Select the desired gift to unlock" :*/
fileprivate let userFileValue:[UInt8] = [0x19,0x2f,0x26,0x2f,0x29,0x3e,0x6a,0x3e,0x22,0x2f,0x6a,0x2e,0x2f,0x39,0x23,0x38,0x2f,0x2e,0x6a,0x2d,0x23,0x2c,0x3e,0x6a,0x3e,0x25,0x6a,0x3f,0x24,0x26,0x25,0x29,0x21]

private func fixingMake(window num: UInt8) -> UInt8 {
    return num ^ 74
}

/*: "OK" :*/
fileprivate let constLineMsg:String = "statusK"

/*: "Select object >" :*/
fileprivate let kEffectUrl:String = "Selecerror mode if color"
fileprivate let showBeautyStr:String = "size"
fileprivate let data_addUrl:String = "true var before show obj"

/*: "It looks like there's nothing" :*/
fileprivate let user_fillKey:[Character] = ["I","t"," ","l","o","o","k","s"," ","l","i","k","e"," ","t","h","e","r","e","\'","s"," ","n","o","t","h","i","n","g"]

/*: "FF75A4" :*/
fileprivate let main_centerName:String = "FF7modeA4"

/*: "E570FF" :*/
fileprivate let const_selectionMessage:[Character] = ["E","5","7","0","F","F"]

/*: "Ask for" :*/
fileprivate let const_mediumPlayerTitle:[Character] = ["A","s","k"," ","f","o"]
fileprivate let main_clickBeginMsg:String = "R"

/*: " Select %@ > " :*/
fileprivate let kRawAppMoreData:String = " Selecsucceed class message"

/*: "All Numbers" :*/
fileprivate let userKitId:String = "All label selected var"

/*: "View detailed description >" :*/
fileprivate let show_assistantStr:[Character] = ["V","i","e","w"," ","d","e","t","a","i","l","e","d"," ","d","e","s","c","r","i","p","t","i"]
fileprivate let showMediumMsg:[Character] = ["o","n"," ",">"]

/*: "\n" :*/
fileprivate let notiNameSizeData:String = "\n"

/*: "%.2f" :*/
fileprivate let app_positionMsg:String = "button level return model%.2f"

/*: "9999" :*/
fileprivate let main_dataFormat:[Character] = ["9","9","9","9"]

/*: "Custom" :*/
fileprivate let k_angleNorText:String = "view"
fileprivate let mainGroupMsg:String = "feetom"

/*: "mf_coin" :*/
fileprivate let appStillUrl:String = "text"
fileprivate let userNamePushPath:[Character] = ["f","_","c","o","i","n"]

/*: "showBagsRed" :*/
fileprivate let constMomentTitle:String = "pathh"
fileprivate let notiToLabUrl:String = "owBagsRedview else back array"
...
typealias SendFunctionBlock = (_ giftModel: TitleGainHandyJSON, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: TitleGainHandyJSON, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: TitleGainHandyJSON) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: TitleGainHandyJSON, _ num: String, _ model: EqualMemberModel) -> Void
// 隐藏礼物面板Block
...
private let constChangeMsg = 44.0
//: let GiftScrollContentView_H = 252.0
let dataStatusMessage = 252.0
//: private let pageControl_H = 7.0
private let app_frameValue = 7.0
//: private let bottomView_H = 44.0
private let appSuccessMsg = 44.0

//: class TalkingChatGiftView: UIView {
class LengthViewDelegate: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = constChangeMsg + dataStatusMessage + app_frameValue + appSuccessMsg + noti_limitPartyInfoUrl
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [ClassMeasurable]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = ClassMeasurable.Hot
    ...
    init(frame: CGRect = .zero, style: ModelTextLiteral = .normal, titlesArr: [ClassMeasurable] = [.Hot, .Vip, .Bags]) {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataInfoMessage.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: user_deviceId, width: constExplainViewMsg, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (userPathValue.replacingOccurrences(of: "main", with: "92")))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.hauntWithoutRadii(width: constExplainViewMsg, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    lazy var partyIconView: ButtonFlowLayout = {
        //: let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: TalkingVoiceRoomIconGiftView_H)
        let frame = CGRect(x: 0, y: 0, width: constExplainViewMsg, height: user_barData)
        //: let view = TalkingVoiceRoomIconGiftView(frame: frame)
        let view = ButtonFlowLayout(frame: frame)
        //: view.isHidden = true
        view.isHidden = true
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: constExplainViewMsg, height: constChangeMsg)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (userPathValue.replacingOccurrences(of: "main", with: "92")))
        //: contentView.addSubview(view)
        contentView.addSubview(view)
        //: return view
        return view
    ...
    private lazy var moneyBtn: BlockButton = {
        //: let btn = TalkingButton()
        let btn = BlockButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.photographicEquipment(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((String(app_addMessage)), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.atomicCount85(name: (String(dataSharedBurnForName))), for: .normal)
    ...
    private lazy var rechargeBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(rechargeBy), for: .touchUpInside)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.atomicCount85(name: (const_userToUrl.replacingOccurrences(of: "resent", with: "i") + String(notiMakeData.suffix(5)) + "ift_mo" + String(dataSumBottomName.prefix(4)) + "rrow"))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.showViewCreate(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.showViewCreate(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(ContainerViewCell.self, forCellWithReuseIdentifier: ContainerViewCell.className())
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: AddViewLayout = //: return hotGiftCollectionView.collectionViewLayout as! AddViewLayout
        hotGiftCollectionView.collectionViewLayout as! AddViewLayout
    //: }()
    ...
    private lazy var titleScrollView: PriceThen = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(noti_fieldStr.prefix(3))).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((show_actualUrl.replacingOccurrences(of: "make", with: "V")).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(notiBoxUrl.prefix(4))).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = HiddenSegmentStyle()
        ...
        let scrollview = PriceThen(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(constChangeMsg)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if WithLanguageManager.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = LineThen.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = LineThen.dataWidth() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !ProjectReactiveCompatible.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var sendAreaView: UIView = {
        ...
        view.layer.borderColor = UIColor.anPathColor().cgColor
    ...
    private lazy var giftNumButton: BlockButton = {
        ...
        btn.setImage(UIImage.atomicCount85(name: (String(app_sizeMsg) + show_howStr.replacingOccurrences(of: "prompt", with: "w"))), for: .normal)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.photographicEquipment(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.anPathColor()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(dataViewEqualMakeMsg)).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(giftWith), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: user_deviceId - CGFloat(keyborHeight) - 44, width: constExplainViewMsg, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.atomicCount85(name: (String(mainNoticeId) + String(mainRestoreName))).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.forClick(color: .anPathColor(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(dataViewEqualMakeMsg)).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.addMsg(showMsg: String(bytes: userFrameMsg.map{stochasticProcess(cell: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.addMsg(showMsg: (String(show_titleData)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.addMsg(showMsg: (String(constStatusName.prefix(5)) + "e sel" + String(user_gesturePath.prefix(5)) + "n obj" + data_greetKey.lowercased()).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = ClassMeasurable(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.inheritance(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: TitleGainHandyJSON = dataArr[index] as! TitleGainHandyJSON
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.anPathColor()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(clickDown(_:)), for: .editingChanged)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(isochronal(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: userFileValue.map{fixingMake(window: $0)}, encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(upwardsDetail), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(kEffectUrl.prefix(5)) + showBeautyStr.replacingOccurrences(of: "size", with: "t") + String(data_addUrl.suffix(4)) + "ect >").localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(seleteFromClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(recite), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.font = UIFont.photographicEquipment(type: .Regular, fontSize: 16)
        //: lab.text = "It looks like there's nothing".localized
        lab.text = (String(user_fillKey)).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.gradientMore(colors: [UIColor(hex: (main_centerName.replacingOccurrences(of: "mode", with: "5")))!.cgColor, UIColor(hex: (String(const_selectionMessage)))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.photographicEquipment(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(const_mediumPlayerTitle) + main_clickBeginMsg.lowercased()).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(askforBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(reciprocation), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension LengthViewDelegate {
    ...
    @objc func panoramicView() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: user_deviceId, width: constExplainViewMsg, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func recover() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: user_deviceId - self.contentHeight, width: constExplainViewMsg, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func upwardsDetail() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = ClassMeasurable(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.inheritance(dataType: dataType)
    ...
    @objc func seleteFromClick() {
        //: meneView = DropDownMemberMenuView.init(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
        meneView = SocietalMenuView(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func recite() {
        //: dismissView()
        panoramicView()
        //: TotalReactiveCompatible.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        TotalReactiveCompatible.share.vane(webViewType: .luckyBlindBox)
    }

    /// 索要礼物
    //: @objc func askforBtnClick() {
    @objc func reciprocation() {
        //: guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
        guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
            //: self.func__showStatusBarErrorMsg(showMsg: "Please select a gift".localized)
            self.addMsg(showMsg: (String(show_titleData)).localized)
...
extension LengthViewDelegate {
    ...
    func bestowment(pkgItemsetId: String, num: Int) {
        //: guard currType == .Bags else { return }
        guard currType == .Bags else { return }
        //: DispatchQueue.main.async {
        DispatchQueue.main.async {
            //: var bagsDataArr = self.getGiftData(dataType: self.currType) as! [TalkingRoomGiftModel]
            var bagsDataArr = self.inheritance(dataType: self.currType) as! [TitleGainHandyJSON]
            // 找到当前背包礼物索引，更新数量
            ...
            ProjectReactiveCompatible.share.foil(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.succeed(force: true)
        }
    }
}

// MARK: - AddLabViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension LengthViewDelegate: AddLabViewDelegate {
    ...
    func makeName(model: EqualMemberModel) {
        ...
        seleteObjectBtn.setTitle((String(kRawAppMoreData.prefix(6)) + "t %@ > ").toAppear(model.nickname), for: .normal)
    }
    ...
    func phaseOfTheMoon() {
        ...
        if model.nickname == (String(userKitId.prefix(4)) + "Numbers").localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! EqualMemberModel
    ...
    func match(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(show_assistantStr) + String(showMediumMsg)).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension LengthViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func inheritance(dataType: ClassMeasurable) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return ProjectReactiveCompatible.share.imageType(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func items() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return ProjectReactiveCompatible.share.indexApp()
    }
    ...
    func undersurface(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == InhibitionValueConvertible.myStery.rawValue)
        }
        ...
        hotGiftLayout.hotDataArr = inheritance(dataType: .Hot)
        //: hotGiftLayout.vipDataArr = getGiftData(dataType: .Vip)
        hotGiftLayout.vipDataArr = inheritance(dataType: .Vip)
        //: hotGiftLayout.bagsDataArr = getGiftData(dataType: .Bags)
        hotGiftLayout.bagsDataArr = inheritance(dataType: .Bags)
    ...
    @objc fileprivate func clickDown(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (String(main_dataFormat))
            //: } else {
        } else {
    ...
    @objc func isochronal(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: user_deviceId - CGFloat(keyborHeight) - 44, width: constExplainViewMsg, height: 44)
    }
    ...
    func clickBy() {
        ...
        let sendingItems = items()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(thanTo(index: i))
//            let giftNumArrModel: BoundaryArrModel = sendingItems[i] as! BoundaryArrModel
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((k_angleNorText.replacingOccurrences(of: "view", with: "C") + mainGroupMsg.replacingOccurrences(of: "fee", with: "us")).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.ValueTextConfig.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = IiDataSource.titleArray(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func placeBottom() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? ContainerViewCell
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.disappearColor(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = ClassMeasurable(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = inheritance(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = ContainerViewCell.className()
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! ContainerViewCell
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = ClassMeasurable(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = inheritance(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: TitleGainHandyJSON = dataArr[indexPath.row] as! TitleGainHandyJSON
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.showView(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.wrap(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = ClassMeasurable(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = inheritance(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == InhibitionValueConvertible.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == InhibitionValueConvertible.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == InhibitionValueConvertible.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                rubricProcess(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = pushData(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = toSign(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            rubricProcess(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: ContainerViewCell = giftSelectedModel.lastHotCell as! ContainerViewCell
                //: cell.setChecked(checked: false)
                cell.wrap(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: ContainerViewCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! ContainerViewCell
            //: currentCell.setChecked(checked: true)
            currentCell.wrap(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.tableImageVideo(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.inheritance(dataType: self.currType)
    ...
    func succeed(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + constExplainViewMsg
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < constExplainViewMsg ? constExplainViewMsg : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / constExplainViewMsg - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(constExplainViewMsg) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = ClassMeasurable.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = ProjectReactiveCompatible.share.modelLikeType(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.animateInput(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && NowInfoThen.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == ClassMeasurable.Hot && self.style == .normal && NowInfoThen.share.loginUserMode.sex == PointExpressionConvertible.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == InhibitionValueConvertible.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                match(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func playModel() {
        ...
        self.giftSelectedModel = MinimumHandyJSON()
...
extension LengthViewDelegate: FrameViewDelegate {
    ...
    func rubricProcess(index: Int, title _: String) {
        ...
        if numberOfGift > 0 {
            ...
            popView?.draft(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.coverPrice(view: self.window!)
    ...
    func thanTo(index: Int) -> Int {
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: BoundaryArrModel = sendingItems[index] as! BoundaryArrModel
    ...
    func toSign(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > items().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension LengthViewDelegate {
    ...
    private func contentSubviews() {
        ...
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: constExplainViewMsg, height: user_deviceId - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(panoramicView)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(dataStatusMessage)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(constExplainViewMsg)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(constExplainViewMsg - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(app_frameValue)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(appSuccessMsg)
        }
    ...
    private func totalerchange() {
        //: NowInfoThen.share.loginUserMode.rx
        NowInfoThen.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (appStillUrl.replacingOccurrences(of: "text", with: "m") + String(userNamePushPath)))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.undersurface(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        ProjectReactiveCompatible.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (constMomentTitle.replacingOccurrences(of: "path", with: "s") + String(notiToLabUrl.prefix(9))))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                ProjectReactiveCompatible.share.progressCompletion(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: NowInfoThen.share.loginUserMode.mf_coin)
                    self.undersurface(needReload: true, mf_coin: NowInfoThen.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })
