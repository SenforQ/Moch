...
fileprivate let const_modelTitle:[UInt8] = [0x30,0x37,0x30,0x2d,0x71,0x3a,0x36,0x3d,0x3c,0x2b,0x63,0x70,0x79,0x31,0x38,0x2a,0x79,0x37,0x36,0x2d,0x79,0x3b,0x3c,0x3c,0x37,0x79,0x30,0x34,0x29,0x35,0x3c,0x34,0x3c,0x37,0x2d,0x3c,0x3d]

private func makeLink(path num: UInt8) -> UInt8 {
    return num ^ 89
}
...
class ThreadMiniView: ModelTailMiniView {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: const_modelTitle.map{makeLink(path: $0)}, encoding: .utf8)!)
    }
...
extension ThreadMiniView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func nameAdd(liveUrl: String) {
...
extension ThreadMiniView: TXLivePlayListener {
