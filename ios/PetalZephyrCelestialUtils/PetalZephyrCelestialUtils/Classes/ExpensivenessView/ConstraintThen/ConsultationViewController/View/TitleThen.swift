...
fileprivate let constTouchName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_tc_warn" :*/
fileprivate let showListLocalKey:String = "super backicon_"

/*: "Live Warning" :*/
fileprivate let notiEqualFormat:String = "Live Wreturn let"
fileprivate let mainColorStr:String = "hidden"

/*: "OK" :*/
fileprivate let kMessageId:String = "centerK"

/*: "Violation Reason: " :*/
fileprivate let data_interactionId:String = "constraint manager make forViol"
fileprivate let data_cellFormat:String = "left causen Rea"
fileprivate let data_coordinatorStr:[Character] = ["s","o","n",":"," "]

/*: "Warning Time: " :*/
fileprivate let main_resultTitle:[Character] = ["W","a","r","n","i","n","g"," ","T"]
fileprivate let noti_requestText:String = "ime: extension view"
...
class TitleThen: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constTouchName.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.atomicCount85(name: (String(showListLocalKey.suffix(5)) + "tc_warn"))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.font = UIFont.photographicEquipment(type: .Semibold, fontSize: 18)
        //: lab.textAlignment = .center
        lab.textAlignment = .center
        //: lab.text = "Live Warning".localized
        lab.text = (String(notiEqualFormat.prefix(6)) + "arni" + mainColorStr.replacingOccurrences(of: "hidden", with: "ng")).localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(capacityMake), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension TitleThen {
    ...
    func messageTime(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.anPathColor()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(data_interactionId.suffix(4)) + "atio" + String(data_cellFormat.suffix(5)) + String(data_coordinatorStr)).localized
        ...
        var timeText = (String(main_resultTitle) + String(noti_requestText.prefix(5))).localized
