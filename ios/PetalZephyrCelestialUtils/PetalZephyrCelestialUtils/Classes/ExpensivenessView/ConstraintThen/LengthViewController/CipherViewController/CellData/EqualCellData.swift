...
@objc public enum SessionTextConvertible: UInt {
...
@objc public enum CanisterMagnitudeLiteral: UInt {
 ...
 */
//: @objcMembers public class EqualCellData: TCommonCellData {
@objcMembers public class EqualCellData: DestabilisationCellData {
    ...
    public var direction: CanisterMagnitudeLiteral = .MsgDirectionIncoming
    ...
    public var translateStatus: SessionTextConvertible = .MsgTranslate_init
    ...
    public var msgModel: ChatModel = ChatModel()
    ...
    public var cellLayout: HiddenCellLayout!
    ...
    public init(direction: CanisterMagnitudeLiteral) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.warning()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = HiddenCellLayout(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = HiddenCellLayout(isIncomming: false)
    ...
    public override func viewDownCamera(_ width: CGFloat) -> CGFloat {
