...
@objcMembers public class HiddenCellLayout: NSObject {
    ...
    class func count() -> HiddenCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = HiddenCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func square() -> HiddenCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = HiddenCellLayout.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func talking() -> HiddenCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = HiddenCellLayout.init(isIncomming: false)
    ...
    class func incommingAndUp() -> HiddenCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = HiddenCellLayout.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func eventLayout() -> HiddenCellLayout {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = HiddenCellLayout.init(isIncomming: false)
        //: return layout
        return layout
