 ...
 *
 *  ModelDelegate 协议和 CipherViewController 类。
 *  CipherViewController 是聊天界面的核心类，负责聊天界面大部分核心业务逻辑的处理与运算。
 *  该类的详细属性与功能，请参展本文件中 CipherViewController 的具体声明。
 *
 ******************************************************************************/
...
@class CipherViewController;
//: @class GainMessageCell;
@class GainMessageCell;
//: @class EqualCellData;
@class EqualCellData;
//: @class V2TIMMessage;
...
- (void)doingdSession:(CipherViewController *)controller;
...
- (void)apps:(CipherViewController *)controller;
...
- (BOOL)custom:(CipherViewController *)controller orientation:(UIView *)view;
 ...
 */
//: - (EqualCellData *)messageController:(TUIMessageController *)controller onNewMessage:(V2TIMMessage *)data;
- (EqualCellData *)release:(CipherViewController *)controller handle:(V2TIMMessage *)data;
 ...
 */
//: - (GainMessageCell *)messageController:(TUIMessageController *)controller onShowMessageData:(EqualCellData *)data;
- (GainMessageCell *)with:(CipherViewController *)controller info:(EqualCellData *)data;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageAvatar:(GainMessageCell *)cell;
- (void)smother:(CipherViewController *)controller intervalerior:(GainMessageCell *)cell;
 ...
 *  @param cell 所点击的消息单元
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageContent:(GainMessageCell *)cell;
- (void)head:(CipherViewController *)controller read:(GainMessageCell *)cell;
 ...
 */
//: - (void)messageController:(TUIMessageController *)controller onSelectMessageMenu:(NSInteger)menuType withData:(EqualCellData *)data;
- (void)orderedSeriesData:(CipherViewController *)controller beauty:(NSInteger)menuType context:(EqualCellData *)data;
/**
...
/*重发*/
//: - (void)messageController:(TUIMessageController *)controller onRetryMessageContent:(GainMessageCell *)cell;
- (void)heliogramTo:(CipherViewController *)controller accumulation:(GainMessageCell *)cell;

/*引用*/
//: - (void)messageController:(TUIMessageController *)controller onReplyMessage:(EqualCellData *)cellData;
- (void)fundamentalMeasure:(CipherViewController *)controller custom:(EqualCellData *)cellData;

/*点击引用*/

//: - (void)messageController:(TUIMessageController *)controller onClickReplyMessage:(EqualCellData *)cellData;
- (void)broadcast:(CipherViewController *)controller texture:(EqualCellData *)cellData;
...
/////////////////////////////////////////////////////////////////////////////////
//
//                         CipherViewController
//
/////////////////////////////////////////////////////////////////////////////////

/**
 * 腾讯云 TUIKit
 *  【模块名称】CipherViewController
 ...
 * @param uiMsgs 待删除的数据
 */
//- (void)deleteMessages:(NSArray<EqualCellData *> *)uiMsgs;
...
/**
 * 批量将V2TIMessage转换成EqualCellData
 */
