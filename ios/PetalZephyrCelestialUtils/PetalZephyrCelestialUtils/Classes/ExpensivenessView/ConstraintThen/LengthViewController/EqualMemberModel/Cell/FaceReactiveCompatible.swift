...
fileprivate let dataPostFormat:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_lounge" :*/
fileprivate let user_styleId:String = "icon_area self let bar"

/*: "icon_home_v" :*/
fileprivate let showNameFormat:String = "ICON"

/*: "My album" :*/
fileprivate let notiSourceFormat:String = "My albfor name color"
fileprivate let dataEqualName:String = "uwarning"

/*: "0A071F" :*/
fileprivate let constFrameUrl:String = "for para make0A071F"

/*: "#C5BEFF" :*/
fileprivate let main_filterShareViewFormat:[Character] = ["#","C","5","B","E","F","F"]

/*: "🎉congratulations! She may be very interested in you. She's not far from you. \nWhy don't you say hello to her?" :*/
fileprivate let k_observerStr:[UInt8] = [0x2a,0x45,0x54,0x53,0xb9,0xb5,0xb4,0xbd,0xa8,0xbb,0xae,0xaf,0xb6,0xbb,0xae,0xb3,0xb5,0xb4,0xa9,0xfb,0xfa,0x89,0xb2,0xbf,0xfa,0xb7,0xbb,0xa3,0xfa,0xb8,0xbf,0xfa,0xac,0xbf,0xa8,0xa3,0xfa,0xb3,0xb4,0xae,0xbf,0xa8,0xbf,0xa9,0xae,0xbf,0xbe,0xfa,0xb3,0xb4,0xfa,0xa3,0xb5,0xaf,0xf4,0xfa,0x89,0xb2,0xbf,0xfd,0xa9,0xfa,0xb4,0xb5,0xae,0xfa,0xbc,0xbb,0xa8,0xfa,0xbc,0xa8,0xb5,0xb7,0xfa,0xa3,0xb5,0xaf,0xf4,0xfa,0xd0,0x8d,0xb2,0xa3,0xfa,0xbe,0xb5,0xb4,0xfd,0xae,0xfa,0xa3,0xb5,0xaf,0xfa,0xa9,0xbb,0xa3,0xfa,0xb2,0xbf,0xb6,0xb6,0xb5,0xfa,0xae,0xb5,0xfa,0xb2,0xbf,0xa8,0xe5]

/*: "Why don't you say hello to her?" :*/
fileprivate let appModeMsg:[UInt8] = [0xc3,0xfc,0xed,0xb4,0xf0,0xfb,0xfa,0xb3,0xe0,0xb4,0xed,0xfb,0xe1,0xb4,0xe7,0xf5,0xed,0xb4,0xfc,0xf1,0xf8,0xf8,0xfb,0xb4,0xe0,0xfb,0xb4,0xfc,0xf1,0xe6,0xab]

private func matchPath(awake num: UInt8) -> UInt8 {
    return num ^ 148
}

/*: "🎉congratulations! He may be very interested in you. He's not far from you. \nWhy don't you say hello to him?" :*/
fileprivate let app_sexFormat:[UInt8] = [0xd2,0x81,0x70,0x6b,0x45,0x51,0x50,0x49,0x54,0x43,0x56,0x57,0x4e,0x43,0x56,0x4b,0x51,0x50,0x55,0x3,0x2,0x2a,0x47,0x2,0x4f,0x43,0x5b,0x2,0x44,0x47,0x2,0x58,0x47,0x54,0x5b,0x2,0x4b,0x50,0x56,0x47,0x54,0x47,0x55,0x56,0x47,0x46,0x2,0x4b,0x50,0x2,0x5b,0x51,0x57,0x10,0x2,0x2a,0x47,0x9,0x55,0x2,0x50,0x51,0x56,0x2,0x48,0x43,0x54,0x2,0x48,0x54,0x51,0x4f,0x2,0x5b,0x51,0x57,0x10,0x2,0xec,0x39,0x4a,0x5b,0x2,0x46,0x51,0x50,0x9,0x56,0x2,0x5b,0x51,0x57,0x2,0x55,0x43,0x5b,0x2,0x4a,0x47,0x4e,0x4e,0x51,0x2,0x56,0x51,0x2,0x4a,0x4b,0x4f,0x21]

fileprivate func periodOfTime(cell num: UInt8) -> UInt8 {
...
/*: "Why don't you say hello to him?" :*/
fileprivate let mainListUrl:[UInt8] = [0x3f,0x6d,0x69,0x68,0x20,0x6f,0x74,0x20,0x6f,0x6c,0x6c,0x65,0x68,0x20,0x79,0x61,0x73,0x20,0x75,0x6f,0x79,0x20,0x74,0x27,0x6e,0x6f,0x64,0x20,0x79,0x68,0x57]

/*: "#FFD13A" :*/
fileprivate let dataCountMessage:String = "#FFD13Aadd color count"

/*: "icon_male_default" :*/
fileprivate let appAcceptTitleMsg:[UInt8] = [0xdf,0xd5,0xd9,0xd8,0xe9,0xdb,0xd7,0xda,0xd3,0xe9,0xd2,0xd3,0xd0,0xd7,0xc3,0xda,0xc2]

private func advantageUser(background num: UInt8) -> UInt8 {
    return num ^ 182
}

/*: "icon_female_default" :*/
fileprivate let notiManagerMessage:String = "sexon"
fileprivate let notiNameTitle:String = "le_defamake name"
fileprivate let app_priceCommentValue:String = "uarray"

/*: "   " :*/
fileprivate let k_resultName:String = "   "

/*: "My interests：" :*/
fileprivate let showColorPath:String = "My inelement since else"
fileprivate let k_halfMsg:[Character] = ["t","e","r","e","s","t","s","\u{ff1a}"]

/*: "btn_me_edit" :*/
fileprivate let main_pathMessage:[Character] = ["b","t","n","_","m","e","_","e","d","i","t"]
...
class FaceReactiveCompatible: InfoViewCell {
    //: var matchData: TalkingChatMatchMsgCellData?
    var matchData: CookieCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataPostFormat.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var infoNameLab: UILabel = {
        ...
        label.font = UIFont.outView(fontSize: 18)
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.atomicCount85(name: (String(user_styleId.prefix(5)) + "lounge"))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var authImgview: UIImageView = {
        ...
        imgV.image = UIImage.atomicCount85(name: (showNameFormat.lowercased() + "_home_v"))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var imgTitleLab: UILabel = {
        ...
        label.font = UIFont.outView(fontSize: 15)
        //: label.textColor = UIColor.appTitleColor()
        label.textColor = UIColor.towardOf()
        //: label.text = "My album".localized
        label.text = (String(notiSourceFormat.prefix(6)) + dataEqualName.replacingOccurrences(of: "warning", with: "m")).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var bgView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(constFrameUrl.suffix(6))))?.withAlphaComponent(0.3)
        //: view.layer.cornerRadius = 12
        view.layer.cornerRadius = 12
        //: view.layer.masksToBounds = true
        view.layer.masksToBounds = true
        ...
        view.layer.borderColor = UIColor(hex: (String(main_filterShareViewFormat)))?.cgColor
        //: return view
        return view
        //: }()
    }()
    ...
    private lazy var matchLab: UILabel = {
        ...
        var str = String(bytes: k_observerStr.map{$0^218}, encoding: .utf8)!.localized
        //: var matchStr = "Why don't you say hello to her?".localized
        var matchStr = String(bytes: appModeMsg.map{matchPath(awake: $0)}, encoding: .utf8)!.localized
        ...
        if NowInfoThen.share.loginUserMode.sex == "2" {
            ...
            str = String(bytes: app_sexFormat.map{periodOfTime(cell: $0)}, encoding: .utf8)!.localized
            //: matchStr = "Why don't you say hello to him?".localized
            matchStr = String(bytes: mainListUrl.reversed(), encoding: .utf8)!.localized
        }
        ...
        var attriString = NSMutableAttributedString(string: str as String, attributes: [.font: UIFont.outView(fontSize: 15), .foregroundColor: UIColor.white])
        ...
        if let range = str.range(of: matchStr) {
            ...
            attriString.addAttributes([NSAttributedString.Key.foregroundColor: UIColor(hex: (String(dataCountMessage.prefix(7))))!], range: nsRange)
        }
...
extension FaceReactiveCompatible {
    ...
    override func compose(with data: DestabilisationCellData) {
        ...
        self.matchData = data as? CookieCellData
        ...
        // 为空时必须初始化
        //: let userInfoModel = self.matchData?.msgModel.userInfoModel ?? LengthThen.init()
        let userInfoModel = self.matchData?.msgModel.userInfoModel ?? LengthThen()
        ...
        if self.vipBgView.isHidden == false {
            //: if let vipModel = NowInfoThen.share.appUserConfigMode.vipSetting.filter({$0.vipSkinId == userInfoModel.vipSkinId}).first {
            if let vipModel = NowInfoThen.share.appUserConfigMode.vipSetting.filter({ $0.vipSkinId == userInfoModel.vipSkinId }).first {
                //: self.vipBgView.setUrlImage(urlStr: vipModel.vipChatSkin, placeImg: nil)
                self.vipBgView.viewFinish(urlStr: vipModel.vipChatSkin, placeImg: nil)
            }
        }
        //: self.headImgView.setUrlImage(urlStr: userInfoModel.headPic)
        self.headImgView.viewFinish(urlStr: userInfoModel.headPic)
        //: self.infoNameLab.textColor = userInfoModel.loungePlus ? .userVipColor():.appTitleColor()
        self.infoNameLab.textColor = userInfoModel.loungePlus ? .equalColor() : .towardOf()
        ...
        let imgStr = userInfoModel.sex == PointExpressionConvertible.male.rawValue ? String(bytes: appAcceptTitleMsg.map{advantageUser(background: $0)}, encoding: .utf8)! : (notiManagerMessage.replacingOccurrences(of: "sex", with: "ic") + "_fema" + String(notiNameTitle.prefix(7)) + app_priceCommentValue.replacingOccurrences(of: "array", with: "lt"))
        //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: imgStr), for: .normal)
        sexBtn.setBackgroundImage(UIImage.atomicCount85(name: imgStr), for: .normal)
        ...
        if userInfoModel.interest.count > 0 {
            ...
            let matchStr = (String(showColorPath.prefix(5)) + String(k_halfMsg)).localized
            ...
            let attributes = [.font: UIFont.outView(fontSize: 15), .foregroundColor: UIColor.anPathColor()] as [NSAttributedString.Key: Any]
            ...
            attrString.addAttributes([NSAttributedString.Key.foregroundColor: UIColor.towardOf()], range: str.range(of: matchStr))
    ...
    func hangView() {
        ...
        let maxCount = Int((constExplainViewMsg - 60) / 62)
        ...
        for index in 0 ..< min(maxCount, matchData.msgModel.userInfoModel.picture.count) {
            ...
            imgV.viewFinish(urlStr: matchData.msgModel.userInfoModel.picture[index])
        ...
        if matchData.msgModel.userInfoModel.picture.count > maxCount {
            ...
            imgV.image = UIImage.atomicCount85(name: (String(main_pathMessage)))
            //: self.pictureView.addSubview(imgV)
            self.pictureView.addSubview(imgV)
            //: imgV.snp.remakeConstraints { make in
            imgV.snp.remakeConstraints { make in
    ...
    override public func updateConstraints() {
        ...
        if userInfoModel.uid.isEmptyString {
            ...
            self.infoView.snp.remakeConstraints { make in
                ...
                make.width.equalTo(constExplainViewMsg - 30)
            ...
            if userInfoModel.interest.count > 0 {
                ...
                let inTheight = self.interestsLab.sizeThatFits(CGSize(width: constExplainViewMsg - 54, height: CGFLOAT_MAX)).height
                ...
                self.interestsLab.snp.remakeConstraints { make in
                    ...
                    make.width.equalTo(constExplainViewMsg - 54)
        ...
        let labelSize = self.matchLab.sizeThatFits(CGSize(width: constExplainViewMsg - 30 - 24, height: CGFLOAT_MAX))
...
extension FaceReactiveCompatible {
    ...
    private func cookie() {
        ...
        let tapGes = UITapGestureRecognizer(target: self, action: #selector(resistanceEqual(_:)))
    ...
    @objc func resistanceEqual(_: UITapGestureRecognizer) {
