...
fileprivate let show_voiceLargeStr:[UInt8] = [0x4c,0x51,0x4c,0x57,0xb,0x46,0x52,0x47,0x48,0x55,0x1d,0xc,0x3,0x4b,0x44,0x56,0x3,0x51,0x52,0x57,0x3,0x45,0x48,0x48,0x51,0x3,0x4c,0x50,0x53,0x4f,0x48,0x50,0x48,0x51,0x57,0x48,0x47]

fileprivate func liveStop(content num: UInt8) -> UInt8 {
...
/*: "nav_back_black_nor" :*/
fileprivate let main_dataName:String = "nav_bavalue and"
fileprivate let constNorKey:[Character] = ["c","k","_","b","l","a","c","k","_","n","o","r"]

/*: "btn_detail_more" :*/
fileprivate let data_toId:String = "manager wrap viewbtn_de"
fileprivate let notiRequestTitle:String = "shared data suite model_more"

/*: "btn_chat_videocall" :*/
fileprivate let data_equalLabText:[Character] = ["b","t","n","_","c","h","a","t","_","v","i","d","e","o","c","a"]
fileprivate let notiMessageStr:String = "LL"

/*: "icon_lounge" :*/
fileprivate let notiGiftText:String = "icon_gift gold"

/*: "Official" :*/
fileprivate let data_contentId:String = "Officialregard make scale"

/*: "Online List" :*/
fileprivate let main_playUrl:String = "value"
fileprivate let show_tipName:[Character] = ["n","l","i","n","e"," ","L","i","s","t"]

/*: "icon_privateChat_intimate" :*/
fileprivate let show_shareStr:[Character] = ["i","c","o","n","_","p","r","i","v","a","t","e","C","h","a","t","_","i","n","t","i","m","a","t","e"]

/*: "#FF60B9" :*/
fileprivate let main_sizeLastName:String = "path bottom double join let#FF60B9"

/*: "Customer Care Center" :*/
fileprivate let appImageMessage:[Character] = ["C","u","s","t","o","m","e","r"," ","C","a"]
fileprivate let const_sharedName:String = "re Cmain info"
fileprivate let constFaceId:String = "ENTER"

/*: "#48FF1E" :*/
fileprivate let k_countryContent:String = "#48FF1if extension"
fileprivate let user_fileUrl:String = "message"

/*: "Online" :*/
fileprivate let dataFirstQuantityTitle:[Character] = ["O","n","l","i","n","e"]

/*: "#FF4B7F" :*/
fileprivate let noti_selectPriceName:[Character] = ["#","F","F","4","B"]
fileprivate let constColorStr:[Character] = ["7","F"]

/*: "busy" :*/
fileprivate let showIconData:String = "bcontentsy"

/*: "+ :*/
fileprivate let data_toMessage:[Character] = ["+"]

/*: "get json error" :*/
fileprivate let show_listMsg:[Character] = ["g","e","t"," ","j","s","o","n"," ","e","r","r","o","r"]

/*: "transform.rotation" :*/
fileprivate let constMakeUrl:String = "transpage"
fileprivate let data_equalValue:[Character] = ["r","m",".","r","o","t","a","t","i","o","n"]

/*: "transform.scale" :*/
fileprivate let appVoiceMessage:[Character] = ["t","r","a","n","s","f","o","r","m",".","s","c","a","l"]
fileprivate let data_modelId:String = "sex"

/*: "zoom&shake" :*/
fileprivate let dataFrontMessage:String = "image"
fileprivate let kSucceedMessage:[Character] = ["o","o","m","&","s","h","a","k","e"]
...
class VisualImageView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: show_voiceLargeStr.map{liveStop(content: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var backButton: UIButton = {
        ...
        let img = UIImage.atomicCount85(name: (String(main_dataName.prefix(6)) + String(constNorKey))).withRenderingMode(.alwaysTemplate)
    ...
    lazy var moreButton: UIButton = {
        ...
        let img = UIImage.atomicCount85(name: (String(data_toId.suffix(6)) + "tail" + String(notiRequestTitle.suffix(5)))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .white
        btn.tintColor = .white
    ...
    lazy var videoCallBtn: UIButton = {
        ...
        let img = UIImage.atomicCount85(name: (String(data_equalLabText) + notiMessageStr.lowercased())).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .white
        btn.tintColor = .white
    ...
    lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.atomicCount85(name: (String(notiGiftText.prefix(5)) + "lounge"))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    lazy var officalImgV: UIButton = {
        ...
        img.setTitle((String(data_contentId.prefix(8))).localized, for: .normal)
    ...
    lazy var onlineListBtn: UIButton = {
        ...
        btn.setTitle((main_playUrl.replacingOccurrences(of: "value", with: "O") + String(show_tipName)).localized, for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var onlineStatusV: BlockButton = {
    ...
    private lazy var myBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(equalTable), for: .touchUpInside)
    ...
    private lazy var userBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(rangeClick), for: .touchUpInside)
        //: btn.imageView?.contentMode = .scaleAspectFill
        btn.imageView?.contentMode = .scaleAspectFill
        //: btn.isHidden = true
        btn.isHidden = true
    ...
    private lazy var intimateBtn: UIButton = {
        ...
        btn.setImage(UIImage.atomicCount85(name: (String(show_shareStr))), for: .normal)
        //: btn.isHidden = true
        btn.isHidden = true
        //: btn.addTarget(self, action: #selector(intimateBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(colorFor), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var intimateLB: UILabel = {
        ...
        lb.textColor = UIColor(hex: (String(main_sizeLastName.suffix(7))))
    ...
    private lazy var addIntimateLB: UILabel = {
        ...
        lb.font = UIFont.photographicEquipment(type: .Semibold, fontSize: 12)
        //: lb.isHidden = true
        lb.isHidden = true
...
extension VisualImageView {
    ...
    func cognomen() {
        ...
        if self.chatType == .service {
            ...
            titleLabel.text = (String(appImageMessage) + String(const_sharedName.prefix(4)) + constFaceId.lowercased()).localized
            //: titleLabel.font = .pingfangFont(type: .Medium, fontSize: 18)
            titleLabel.font = .photographicEquipment(type: .Medium, fontSize: 18)
            //: titleLabel.textColor = .appTitleColor()
            titleLabel.textColor = .towardOf()
    ...
    func dowery() {
        ...
        if self.chatType == .service { // 官方客服
            ...
            let offset = WithLanguageManager.shared.direction == .leftToRight ? 22 : -22
    ...
    ///   - userModel: 用户信息
    ///   - isFrom: 列表控制器入口
    //: func private_updateNavView(userModel: LengthThen, isFrom: PrivateChatIsFromEnum) {
    func withData(userModel: LengthThen, isFrom: PriceViewFromEnum) {
        ...
        if userModel.onlineStatus == 1 {
            ...
            let image = UIImage.colorDetail(color: UIColor(hex: (String(k_countryContent.prefix(6)) + user_fileUrl.replacingOccurrences(of: "message", with: "E")))!, size: CGSize(width: 8, height: 8))
            //: onlineStatusV.setImage(image.closingUniform(), for: .normal)
            onlineStatusV.setImage(image.closingUniform(), for: .normal)
            //: onlineStatusV.setTitle("Online".localized, for: .normal)
            onlineStatusV.setTitle((String(dataFirstQuantityTitle)).localized, for: .normal)
            ...
            let image = UIImage.colorDetail(color: UIColor(hex: (String(noti_selectPriceName) + String(constColorStr)))!, size: CGSize(width: 8, height: 8))
            //: onlineStatusV.setImage(image.closingUniform(), for: .normal)
            onlineStatusV.setImage(image.closingUniform(), for: .normal)
            //: onlineStatusV.setTitle("busy".localized, for: .normal)
            onlineStatusV.setTitle((showIconData.replacingOccurrences(of: "content", with: "u")).localized, for: .normal)
            //: } else {
        } else {
        ...
        titleLabel.textColor = userModel.loungePlus ? .equalColor() : .white
        ...
        var videoCall = userModel.enableVideoCall
        //: if isFrom == .LiveRoom || NowInfoThen.share.appStatus == AppSkinStatus.special.rawValue {
        if isFrom == .LiveRoom || NowInfoThen.share.appStatus == PointRelatableTarget.special.rawValue {
            //: videoCall = false
            videoCall = false
        }
        //: if videoCall {
    ...
    /// - Parameters:
    ///   - userModel: 用户信息
    //: func private_updateIntimateNavView(userModel: LengthThen) {
    func startUser(userModel: LengthThen) {
        ...
        userBtn.isHidden = false
        //: myBtn.setUrlImage(urlStr: NowInfoThen.share.loginUserMode.headPic ?? "")
        myBtn.equalButton(urlStr: NowInfoThen.share.loginUserMode.headPic ?? "")
        //: userBtn.setUrlImage(urlStr: userModel.headPic)
        userBtn.equalButton(urlStr: userModel.headPic)
    ...
    func stopCountimate(intimate: Int) {
        //: let str  = "+\(intimate)"
        let str = "+\(intimate)"
        ...
        let attributes = [.foregroundColor: UIColor.white, .font: UIFont.photographicEquipment(type: .Semibold, fontSize: 12)] as [NSAttributedString.Key: Any]
        ...
        let url = ProduceActionReactiveCompatible.default.distaffType(type: .Private_Chat_intimate)
        //: do {
        do {
            ...
            printLog(message: (String(show_listMsg)))
        }
    }
    ...
    func upOf(intimate: Int) {
        //: intimateLB.text = "\(intimate)"
        intimateLB.text = "\(intimate)"
    }

    //: @objc func myBtnClick() {
    @objc func equalTable() {
        //: TotalReactiveCompatible.share.func__pushToUserDetailVC(uid: NowInfoThen.share.loginUserMode.userID)
        TotalReactiveCompatible.share.arrange(uid: NowInfoThen.share.loginUserMode.userID)
    }

    //: @objc func userIconClick() {
    @objc func rangeClick() {
        //: TotalReactiveCompatible.share.func__pushToUserDetailVC(uid: userId)
        TotalReactiveCompatible.share.arrange(uid: userId)
    }
    ...
    @objc func colorFor() {
        ...
        let view = ValueDataSource(frame: CGRect(x: 0, y: 0, width: constExplainViewMsg, height: user_deviceId))
        //: view.show()
        view.behindButton()
    }
    ...
    func plot() {
        ...
        let roate = CAKeyframeAnimation(keyPath: (constMakeUrl.replacingOccurrences(of: "page", with: "fo") + String(data_equalValue)))
        ...
        let zoom = CAKeyframeAnimation(keyPath: (String(appVoiceMessage) + data_modelId.replacingOccurrences(of: "sex", with: "e")))
        ...
        videoCallBtn.layer.add(groupAnnimation, forKey: (dataFrontMessage.replacingOccurrences(of: "image", with: "z") + String(kSucceedMessage)))
    }
}
