...
fileprivate let showExtraId:[UInt8] = [0x97,0x90,0x97,0x8a,0xd6,0x9d,0x91,0x9a,0x9b,0x8c,0xc4,0xd7,0xde,0x96,0x9f,0x8d,0xde,0x90,0x91,0x8a,0xde,0x9c,0x9b,0x9b,0x90,0xde,0x97,0x93,0x8e,0x92,0x9b,0x93,0x9b,0x90,0x8a,0x9b,0x9a]
...
class TrifleShieldView: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func loadArray(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return TrifleShieldView(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showExtraId.map{$0^254}, encoding: .utf8)!)
    }
