...
@property (nonatomic, strong)DailyModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)PushModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)CenterModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)VanguardModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)TimeDailyModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)GiftModel *quoteMsgInfo;

//: @property (nonatomic, strong)LengthThen *userInfoModel;
@property (nonatomic, strong)LengthThen *userInfoModel;
...
@property (nonatomic, strong) OpenModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) AlongModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) QuerylistModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) AllMakeModel *wantGift; /// 想要礼物
...
@interface QuerylistModel: JSONModel
...
@interface CenterModel : JSONModel
...
@interface VanguardModel : JSONModel
...
@interface TimeDailyModel : JSONModel
...
@interface AllMakeModel : JSONModel
...
@property (nonatomic, strong) AppChatModel *renderData;
...
@interface AppChatModel : JSONModel
