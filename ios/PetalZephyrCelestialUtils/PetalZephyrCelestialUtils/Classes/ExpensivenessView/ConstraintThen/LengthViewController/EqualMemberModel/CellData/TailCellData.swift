...
/*: _" :*/
fileprivate let constAddTitle:[Character] = ["_"]

/*: ".png" :*/
fileprivate let k_stopPath:String = ".pnginfo view"
...
//: @objcMembers public class TailCellData: TalkingChatMsgBaseCellData {
@objcMembers public class TailCellData: PriceCellData {
    ...
    override public var msgModel: ChatModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.stateDetail(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func addImage(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(data_formatName)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + NowInfoThen.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + NowInfoThen.share.loginUserMode.userID + (String(k_stopPath.prefix(4)))
        ...
        let imageData = UIImage.gift(image, origin: 2 * 1024)
