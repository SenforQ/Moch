...
fileprivate let userMakeWithData:[UInt8] = [0xc1,0xc6,0xc1,0xcc,0x80,0xbb,0xc7,0xbc,0xbd,0xca,0x92,0x81,0x78,0xc0,0xb9,0xcb,0x78,0xc6,0xc7,0xcc,0x78,0xba,0xbd,0xbd,0xc6,0x78,0xc1,0xc5,0xc8,0xc4,0xbd,0xc5,0xbd,0xc6,0xcc,0xbd,0xbc]

fileprivate func imageBegin(state num: UInt8) -> UInt8 {
...
/*: "icon_mini_voice_end" :*/
fileprivate let app_currentKey:String = "icon_view let"
fileprivate let constViewStr:String = "oice_eview frame"
fileprivate let mainKindRowStr:String = "ninfo"

/*: "#F95151" :*/
fileprivate let userEqualStr:[Character] = ["#","F","9","5","1","5","1"]

/*: "End of call" :*/
fileprivate let showNameFormat:[Character] = ["E","n","d"," ","o","f"," ","c","a"]
fileprivate let constViewStaffId:String = "keykey"

/*: "img_home_shadow_icon" :*/
fileprivate let show_messageKey:String = "icon round regularimg_ho"
fileprivate let show_withTableId:String = "objectdow"
...
class ChangeReactiveCompatible: ModelTailMiniView {
    // 小窗口通话状态
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userMakeWithData.map{imageBegin(state: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var statusIcon: UIImageView = {
        ...
        img.image = UIImage.atomicCount85(name: (String(app_currentKey.prefix(5)) + "mini_v" + String(constViewStr.prefix(6)) + mainKindRowStr.replacingOccurrences(of: "info", with: "d")))
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(userEqualStr)))
        ...
        lab.text = (String(showNameFormat) + constViewStaffId.replacingOccurrences(of: "key", with: "l")).localized
    ...
    private lazy var shadowImg: UIImageView = {
        ...
        img.image = UIImage.atomicCount85(name: (String(show_messageKey.suffix(6)) + "me_sh" + show_withTableId.replacingOccurrences(of: "object", with: "a") + "_icon"))
...
extension ChangeReactiveCompatible {
    ...
    static func wisecrack() -> ChangeReactiveCompatible {
        //: let view = TalkingVideoMiniView(frame: .zero)
        let view = ChangeReactiveCompatible(frame: .zero)
...
extension ChangeReactiveCompatible {
    ...
    private func restrictionBarSubActionEqual() {
