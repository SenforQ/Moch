...
fileprivate let data_centerInsertName:[UInt8] = [0x2a,0x2d,0x2a,0x37,0x6b,0x20,0x2c,0x27,0x26,0x31,0x79,0x6a,0x63,0x2b,0x22,0x30,0x63,0x2d,0x2c,0x37,0x63,0x21,0x26,0x26,0x2d,0x63,0x2a,0x2e,0x33,0x2f,0x26,0x2e,0x26,0x2d,0x37,0x26,0x27]

private func fullMoon(cover num: UInt8) -> UInt8 {
    return num ^ 67
}
...
class ModelItemLabel: UIView {
    //: private var giftSendItem = [TalkingGiftNumArrModel()]
    private var giftSendItem = [BoundaryArrModel()]
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_centerInsertName.map{fullMoon(cover: $0)}, encoding: .utf8)!)
    }
    ...
    func bucket(attributedText: NSAttributedString) {
        ...
        shadow.shadowColor = UIColor.heatherMixture()
    ...
    func statisticalTable(frame: CGRect) {
        //: self.frame = frame
        self.frame = frame
    ...
    private lazy var gradientLayer: CAGradientLayer = {
        ...
        lay.colors = [UIColor.showViewCreate(255, 232, 72, 1).cgColor, // 浅黄
                      //: UIColor.RGBA(253, 170, 52, 1).cgColor
                      UIColor.showViewCreate(253, 170, 52, 1).cgColor, // 深黄
        ]
