...
fileprivate let kViewRawName:[UInt8] = [0xb7,0xb0,0xb7,0xaa,0xf6,0xbd,0xb1,0xba,0xbb,0xac,0xe4,0xf7,0xfe,0xb6,0xbf,0xad,0xfe,0xb0,0xb1,0xaa,0xfe,0xbc,0xbb,0xbb,0xb0,0xfe,0xb7,0xb3,0xae,0xb2,0xbb,0xb3,0xbb,0xb0,0xaa,0xbb,0xba]

private func beMessage(wrap num: UInt8) -> UInt8 {
    return num ^ 222
}

/*: "icon_home_boy" :*/
fileprivate let const_buttonName:String = "any if selected indexicon_"
fileprivate let notiViewTopStr:String = "_boytarget let m let view"

/*: "icon_home_girl" :*/
fileprivate let show_giftPath:[Character] = ["i","c","o","n","_","h","o","m"]
fileprivate let data_atKey:String = "image pute_girl"

/*: "   " :*/
fileprivate let k_viewId:String = "beginbeginbegin"
...
class DeleteListCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kViewRawName.map{beMessage(wrap: $0)}, encoding: .utf8)!)
    }
...
extension DeleteListCell {
    //: func setOnlineListCell(model: TalkingChatRoomMemberModel, type: TitleType) {
    func addOn(model: EqualMemberModel, type: ViewSequence) {
        ...
        case 1:
            ...
            sexBtn.setBackgroundImage(UIImage.atomicCount85(name: (String(const_buttonName.suffix(5)) + "home" + String(notiViewTopStr.prefix(4)))), for: .normal)
        //: break
        //: case 2:
        case 2:
            //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: "icon_home_girl"), for: .normal)
            sexBtn.setBackgroundImage(UIImage.atomicCount85(name: (String(show_giftPath) + String(data_atKey.suffix(6)))), for: .normal)
        //: break
        //: default:
        default:
            //: break
