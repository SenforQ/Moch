...
/*: "App" :*/
fileprivate let showBackgroundText:[Character] = ["A","p","p"]

/*: "blockList_ :*/
fileprivate let constLikeData:[Character] = ["b","l","o","c","k","L","i","s","t","_"]
...
// __CLOSE_PRINT__
//
//  BritishWestAfricaAdministratorReactiveCompatible.swift
//  AbroadTalking
//
...
class BritishWestAfricaAdministratorReactiveCompatible: NSObject {
    //: var blockList: [String]?
    var blockList: [String]? // 拉黑列表

    // singleton
    //: static let shared = TalkingBlockListManager()
    static let shared = BritishWestAfricaAdministratorReactiveCompatible()
    ...
    private func constituent() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(showBackgroundText)))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(constLikeData)) + "\(uid)")
        //: return filePath
        return filePath
    }
}
