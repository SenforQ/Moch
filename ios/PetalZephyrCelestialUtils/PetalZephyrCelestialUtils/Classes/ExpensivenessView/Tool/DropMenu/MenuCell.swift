...
fileprivate let kLeadingUrl:[UInt8] = [0xe4,0xe3,0xe4,0xf9,0xa5,0xee,0xe2,0xe9,0xe8,0xff,0xb7,0xa4,0xad,0xe5,0xec,0xfe,0xad,0xe3,0xe2,0xf9,0xad,0xef,0xe8,0xe8,0xe3,0xad,0xe4,0xe0,0xfd,0xe1,0xe8,0xe0,0xe8,0xe3,0xf9,0xe8,0xe9]

private func worldView(add num: UInt8) -> UInt8 {
    return num ^ 141
}
...
class MenuCell: UITableViewCell {
    ...
    lazy var menuImageView: UIImageView = self.blockWarning()
    //: lazy var menuTitleLabel: UILabel = self.makeMenuTitleLable()
    lazy var menuTitleLabel: UILabel = self.arrayTo()
    ...
    var dropMenuStyle: IngredientMenuStyle? {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kLeadingUrl.map{worldView(add: $0)}, encoding: .utf8)!)
    }
    ...
    private func blockWarning() -> UIImageView {
    ...
    private func chorus() {
        ...
        lineLayer.strokeColor = UIColor.showViewCreate(230, 230, 230, 1.0).cgColor
