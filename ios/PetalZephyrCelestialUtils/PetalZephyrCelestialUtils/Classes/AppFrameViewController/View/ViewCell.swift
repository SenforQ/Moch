...
fileprivate let k_onName:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "+ :*/
fileprivate let main_pointStr:String = "party"

/*: "area_icon_ :*/
fileprivate let appTapId:String = "attach style bararea_i"

/*: @2x" :*/
fileprivate let appEqualSucceedData:String = "@2xreturn vertical for"

/*: "get img error" :*/
fileprivate let dataGiftViewPath:[Character] = ["g","e","t"," ","i","m","g"," ","e","r"]
fileprivate let const_makeValue:[Character] = ["r","o","r"]
...
class ViewCell: UITableViewCell {
    ...
    required init?(coder: NSCoder) {
        ...
        fatalError(String(bytes: k_onName.reversed(), encoding: .utf8)!)
    }
...
extension ViewCell {
    ...
    public func makingKnown(areaModel: CompartmentModelType) {
        ...
        if areaModel.url.isEmptyString {
            ...
            imageName = (String(appTapId.suffix(6)) + "con_") + "\(imageName)@2x"
            //: do {
            do {
                ...
                areaImgView.image = UIImage.warning()
                //: printLog(message: "get img error")
                printLog(message: (String(dataGiftViewPath) + String(const_makeValue)))
            }
            //: }else {
        } else {
            //: areaImgView.setUrlImage(urlStr: areaModel.url)
            areaImgView.viewFinish(urlStr: areaModel.url)
        }
    }
}
