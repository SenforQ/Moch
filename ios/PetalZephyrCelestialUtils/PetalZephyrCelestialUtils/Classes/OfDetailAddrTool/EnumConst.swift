...
/// 性别
//: enum Gender: String {
enum PointExpressionConvertible: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum ToTableConvertible: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
enum ActionContiguousBytes: String {
    //: case unknown = "-1"       // 未申请
    case unknown = "-1" // 未申请
...
@objc enum PointRelatableTarget: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum ContainerMirrorPath: Int {
    //: case Unavailable = 0
...
enum BeautyCaseIterable: CaseIterable {
...
enum EnableThreadTypeQuickLookable: Int {
    //: case nor = 1
    case nor = 1
    //: case match = 2
    case match = 2
