...
extension Dictionary {
    ...
    public static func isPoint(withJsonString jsonString: String?) -> [String: Any]? {
...
extension NSDictionary {
    ...
    @objc public class func squareOn(withJsonString jsonString: String?) -> NSDictionary? {
        //: guard let result = Dictionary<String, Any>.dictionary(withJsonString: jsonString) else {
        guard let result = Dictionary<String, Any>.isPoint(withJsonString: jsonString) else {
            //: return nil
            return nil
        }
