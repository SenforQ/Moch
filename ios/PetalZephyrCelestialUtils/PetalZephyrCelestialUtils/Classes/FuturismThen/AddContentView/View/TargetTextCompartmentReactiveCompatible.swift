...
fileprivate let app_styleKey:[UInt8] = [0xc8,0xcf,0xc8,0xd5,0x89,0xc2,0xce,0xc5,0xc4,0xd3,0x9b,0x88,0x81,0xc9,0xc0,0xd2,0x81,0xcf,0xce,0xd5,0x81,0xc3,0xc4,0xc4,0xcf,0x81,0xc8,0xcc,0xd1,0xcd,0xc4,0xcc,0xc4,0xcf,0xd5,0xc4,0xc5]
...
// __CLOSE_PRINT__
//
//  TargetTextCompartmentReactiveCompatible.swift
//  AbroadTalking
//
...
enum ButtonTarotSwipeDirection: CaseIterable {
    //: case Left
    case Left
    //: case Right
    case Right
...
protocol AppCellDelegete: NSObjectProtocol {
    ///
...
class TargetTextCompartmentReactiveCompatible: UIView {
    ...
    var cell_delegate: AppCellDelegete?

    //: var model: TalkingMatchResultModel?
    var model: BlockSaveResultModel?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_styleKey.map{$0^161}, encoding: .utf8)!)
    }
    ...
    private lazy var tapGesture: UIPanGestureRecognizer = {
        ...
        let v = UIPanGestureRecognizer(target: self, action: #selector(openMoment(pan:)))
        //: v.delegate = self
        v.delegate = self
        //: return v
        return v
...
extension TargetTextCompartmentReactiveCompatible: UIGestureRecognizerDelegate {
    ...
    @objc func openMoment(pan: UIPanGestureRecognizer) {
        //: switch pan.state {
        switch pan.state {
        //: case .began:
        case .began:
        ...
        case .changed:
            ...
            if WithLanguageManager.shared.direction == .rightToLeft {
                ...
                if movePoint.x > constExplainViewMsg / 4 {
                    ...
                    self.cell_delegate?.misestimationPoint(cell: self, forMovePoint: self.currentPoint)
    ...
    func groupDirection(direction: ButtonTarotSwipeDirection) {
        //: switch (direction) {
        switch direction {
        //: case .Left:
        case .Left:
...
extension TargetTextCompartmentReactiveCompatible {
    //: func setupView() {
    func dataObserve() {
