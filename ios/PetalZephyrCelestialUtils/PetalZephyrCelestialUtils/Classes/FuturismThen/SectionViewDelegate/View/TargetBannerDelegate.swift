...
fileprivate let noti_equipmentName:[UInt8] = [0xfc,0x1,0xfc,0x7,0xbb,0xf6,0x2,0xf7,0xf8,0x5,0xcd,0xbc,0xb3,0xfb,0xf4,0x6,0xb3,0x1,0x2,0x7,0xb3,0xf5,0xf8,0xf8,0x1,0xb3,0xfc,0x0,0x3,0xff,0xf8,0x0,0xf8,0x1,0x7,0xf8,0xf7]

fileprivate func openTab(model num: UInt8) -> UInt8 {
...
/*: "JXBannerCellID" :*/
fileprivate let k_leadingKey:[Character] = ["J","X","B","a","n","n","e","r","C","e","l","l","I"]
fileprivate let dataEnableValue:String = "player"
...
class TargetBannerDelegate: UITableViewCell {
    //: private var adBannderListData = [SocialAdBannerModel]()
    private var adBannderListData = [SocietalTitleDivinatoryRecitalModelType]()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: noti_equipmentName.map{openTab(model: $0)}, encoding: .utf8)!)
    }
...
extension TargetBannerDelegate: JXBannerDataSource, JXBannerDelegate {
    //: func jxBanner(_ banner: JXBannerType) -> (JXBannerCellRegister) {
    func jxBanner(_: JXBannerType) -> (JXBannerCellRegister) {
        //: return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: "JXBannerCellID")
        return JXBannerCellRegister(type: JXBannerCell.self, reuseIdentifier: (String(k_leadingKey) + dataEnableValue.replacingOccurrences(of: "player", with: "D")))
    }
...
extension TargetBannerDelegate {
    /// 更新数据
    //: func setViewData(bannerData: [SocialAdBannerModel]) {
    func superposeTextInformationEqual(bannerData: [SocietalTitleDivinatoryRecitalModelType]) {
