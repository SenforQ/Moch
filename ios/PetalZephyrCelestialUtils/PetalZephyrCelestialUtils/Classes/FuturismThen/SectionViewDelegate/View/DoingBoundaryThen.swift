...
fileprivate let data_modelId:[UInt8] = [0xba,0xbd,0xba,0xa7,0xfb,0xb0,0xbc,0xb7,0xb6,0xa1,0xe9,0xfa,0xf3,0xbb,0xb2,0xa0,0xf3,0xbd,0xbc,0xa7,0xf3,0xb1,0xb6,0xb6,0xbd,0xf3,0xba,0xbe,0xa3,0xbf,0xb6,0xbe,0xb6,0xbd,0xa7,0xb6,0xb7]

private func explainMoment(text num: UInt8) -> UInt8 {
    return num ^ 211
}

/*: "btn_me_edit" :*/
fileprivate let userAirMsg:String = "btn_array value pic image"

/*: "icon_me_lw" :*/
fileprivate let k_logActualName:String = "icon_min type"
fileprivate let app_buttonUrl:String = "e_lwtitle special make"

/*: " Reward" :*/
fileprivate let user_sectionId:String = "video display else Reward"

/*: "FF506D" :*/
fileprivate let show_contentName:String = "FF506view"
...
class DoingBoundaryThen: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_modelId.map{explainMoment(text: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.atomicCount85(name: (String(userAirMsg.prefix(4)) + "me_edit")))
        //: return imag
        return imag
        //: }()
    }()
    ...
    private lazy var taskCenterBtn: UIButton = {
        ...
        btn.setImage(UIImage.atomicCount85(name: (String(k_logActualName.prefix(6)) + String(app_buttonUrl.prefix(4)))), for: .normal)
        //: btn.setTitle(" Reward".localized, for: .normal)
        btn.setTitle((String(user_sectionId.suffix(7))).localized, for: .normal)
        //: btn.setTitleColor(UIColor.init(hex: "FF506D"), for: .normal)
        btn.setTitleColor(UIColor(hex: (show_contentName.replacingOccurrences(of: "view", with: "D"))), for: .normal)
...
extension DoingBoundaryThen {
    ...
    private func slideSub() {
        ...
        backView.frame = CGRect(x: 15, y: 0, width: constExplainViewMsg - 30, height: backView_h)
        ...
        if index == 0, islast {
            ...
            backView.hauntWithoutRadii(width: backView.frame.size.width,
