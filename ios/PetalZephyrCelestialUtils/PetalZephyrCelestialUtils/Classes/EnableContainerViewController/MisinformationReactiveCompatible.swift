...
// __CLOSE_PRINT__
//
//  MisinformationReactiveCompatible.swift
//  AbroadTalking
//
...
class MisinformationReactiveCompatible: UINavigationController {

    //: var tabBarType: TabBarItemType?
    var tabBarType: BlockWidthNumber?
    //: var pushing = false                             
    ...
    override func pushViewController(_ viewController: UIViewController, animated: Bool) {
        ...
        if viewControllers.count >= 1 {
            ...
            if viewController.navigationItem.leftBarButtonItem == nil {
                ...
                viewController.navigationItem.leftBarButtonItem = viewController.noAdd()
            }
        }
    ...
    func mixIn() {
        ...
        if #available(iOS 15.0, *) {
            ...
            barApp.backgroundImage = UIImage.equalDismiss(color: UIColor.white)
            //: barApp.shadowImage = UIImage.init()
            barApp.shadowImage = UIImage.init()
            //: barApp.shadowColor = UIColor.appBgColor()
            barApp.shadowColor = UIColor.objectVideoBurn()
            ...
            barApp.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.towardOf(), NSAttributedString.Key.font: UIFont.photographicEquipment(type: .Medium, fontSize: 17)]
        ...
        //: } else {
            ...
            navigationBar.setBackgroundImage(UIImage.equalDismiss(color: UIColor.white), for: .any, barMetrics: .default)
            ...
            navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.towardOf(), NSAttributedString.Key.font: UIFont.photographicEquipment(type: .Medium, fontSize: 17)]
        }
        //: UINavigationBar.appearance().tintColor = UIColor.appTitleColor()
        UINavigationBar.appearance().tintColor = UIColor.towardOf()
...
extension MisinformationReactiveCompatible: UINavigationControllerDelegate {
...
extension MisinformationReactiveCompatible: UIGestureRecognizerDelegate {
