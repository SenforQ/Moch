...
/*: "#777777" :*/
fileprivate let notiFrameValue:String = "#777777"

/*: "#333333" :*/
fileprivate let userAddExplainName:String = "#333333"

/*: "Search" :*/
fileprivate let show_dataValue:String = "Searchbackground view let block wrap"

/*: "Details" :*/
fileprivate let constFrameMessage:String = "in center path let halfDetails"

/*: "nav_back_black_nor" :*/
fileprivate let dataEraseMessage:[Character] = ["n","a","v","_","b","a","c","k","_","b","l","a","c","k","_","n","o","r"]
...
class CookieThen: TailRecognizerDelegate {
    ...
    private lazy var categoryView: JXSegmentedView = {
        ...
        segmentedDataSource.titleNormalColor = UIColor(hex: (notiFrameValue.capitalized))!
        //: segmentedDataSource.titleSelectedColor = UIColor.init(hex: "#333333")!
        segmentedDataSource.titleSelectedColor = UIColor(hex: (userAddExplainName.capitalized))!
        ...
        indicator.indicatorColor = UIColor(hex: (userAddExplainName.capitalized))!
...
//        view.defaultSelectedIndex = currentIndex
    ...
    private lazy var titleArray: [String] = //: return ["Search".localized, "Details".localized]
        [(String(show_dataValue.prefix(6))).localized, (String(constFrameMessage.suffix(7))).localized]
    //: }()

    //: private lazy var dataVC: [TalkingBaseViewController] = {
    private lazy var dataVC: [TailRecognizerDelegate] = //: return [AppObjectProtocol(), SaveViewController()]
        [AppObjectProtocol(), SaveViewController()]
    //: }()
    ...
    private lazy var backButton: UIButton = {
        ...
        let img = UIImage.atomicCount85(name: (String(dataEraseMessage))).withRenderingMode(.alwaysTemplate)
        //: btn.setImage(img, for: .normal)
        btn.setImage(img, for: .normal)
        //: btn.tintColor = .black
        btn.tintColor = .black
        //: btn.addTarget(self, action: #selector(backButtonClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(touchClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension CookieThen: JXSegmentedViewDelegate {
...
extension CookieThen: JXPagingViewDelegate {
...
extension CookieThen {
    ...
    private func nameWithSwaddlingClothes() {
