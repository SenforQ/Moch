...
extension TiedTool {
    ...
    func upSumeraction(_ frontCamera: Bool) {
        ...
        self.operation(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func asInsertDismiss(_ openCamera: Bool) {
        ...
        self.enableLocation(isOpen: openCamera)
    }
    ...
    func curtainView() {
        ...
        DispatchQueue.main.async {
            ...
            self.backCurrent(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension TiedTool {
    ...
    private func operation(front: Bool) {
    ...
    private func enableLocation(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard notiAppPath == true else {
            //: if isOpen {
            if isOpen {
...
extension TiedTool {
    ...
    func roundImage() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(magnitudePing(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(pushTitle(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(textVideo(notif:)),
    ...
    @objc private func magnitudePing(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func pushTitle(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func noRow(notif: Notification) {
    ...
    @objc func textVideo(notif: Notification) {
...
extension TiedTool {
    ...
    func backCurrent(smallWindow: Bool) {
        //: guard SenseTime_Use == true else {
        guard notiAppPath == true else {
