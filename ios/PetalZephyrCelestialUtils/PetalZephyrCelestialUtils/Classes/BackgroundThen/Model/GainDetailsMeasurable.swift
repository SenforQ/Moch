...
/*: "id" :*/
fileprivate let mainGenderId:String = "bottomd"
...
struct GainDetailsMeasurable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: SocialMomentModel?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [EquipmentHandyJSON]? // 相册
    ...
    var aiExtraInfo = LengthCenterHandyJSON() // AI模型
    //: var vipSkinId = 0
...
struct SocialMomentModel: HandyJSON {
    //: var count: Int = 0
    var count: Int = 0
    //: var list: Array<TalkingUserInfoMomentItemModel>?
    var list: [ReportCardTransformable]?
}

// MARK: - 动态Item

//: struct TalkingUserInfoMomentItemModel: HandyJSON {
struct ReportCardTransformable: HandyJSON {
...
struct EquipmentHandyJSON: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func generateMoment(compareTo: EquipmentHandyJSON) -> Bool {
        //: return
        return
...
struct LengthCenterHandyJSON: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
...
enum FaceEnableTransformable: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1
