...
fileprivate let notiAddModelValue:[UInt8] = [0xe2,0xe5,0xe2,0xff,0xa3,0xe8,0xe4,0xef,0xee,0xf9,0xb1,0xa2,0xab,0xe3,0xea,0xf8,0xab,0xe5,0xe4,0xff,0xab,0xe9,0xee,0xee,0xe5,0xab,0xe2,0xe6,0xfb,0xe7,0xee,0xe6,0xee,0xe5,0xff,0xee,0xef]

private func nameParty(layer num: UInt8) -> UInt8 {
    return num ^ 139
}

/*: "icon_me_voice_white" :*/
fileprivate let app_makeUrl:String = "icdata"
fileprivate let const_addName:[Character] = ["n","_","m","e","_","v","o","i","c","e","_","w","h","i","t","e"]

/*: "btn_auto_write" :*/
fileprivate let constCountimateAspectKey:String = "string height itembtn_a"

/*: "Pending review" :*/
fileprivate let show_blackRedValue:[Character] = ["P","e","n","d","i","n","g"," ","r","e","v","i","e"]
fileprivate let main_makeAfterMessage:String = "size"

/*: "%d″" :*/
fileprivate let showRequestContent:String = "clear text height size%d″"

/*: "get json error" :*/
fileprivate let noti_sendKey:String = "get jsdata agent calculation hidden"
fileprivate let dataMaleTitle:[Character] = ["r","o","r"]
...
class DeIonateViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiAddModelValue.map{nameParty(layer: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var audioBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.gradientMore(colors: UIColor.showCorner(), size: CGSize(width: 155, height: 35)), for: .normal)
        //: btn.layer.cornerRadius = 17.5
        btn.layer.cornerRadius = 17.5
        //: btn.clipsToBounds = true
        btn.clipsToBounds = true
        //: btn.addTarget(self, action: #selector(recordBtnAction), for: .touchUpInside)
        btn.addTarget(self, action: #selector(towardTalk), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    lazy var playIconView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.atomicCount85(name: (app_makeUrl.replacingOccurrences(of: "data", with: "o") + String(const_addName))))
        //: return imag
        return imag
        //: }()
    }()
    ...
    lazy var editBtn: UIButton = {
        ...
        btn.setImage(UIImage.atomicCount85(name: (String(constCountimateAspectKey.suffix(5)) + "uto_write")), for: .normal)
...
extension DeIonateViewCell {
    //: @objc func recordBtnAction() {
    @objc func towardTalk() {
    ...
    func move(model: ValueGreetModel, row: Int, isLast: Bool) {
        //: index = row
        index = row
        //: islast = isLast
        islast = isLast
        ...
        if model.status == 0 {
            ...
            statusLb.text = (String(show_blackRedValue) + main_makeAfterMessage.replacingOccurrences(of: "size", with: "w")).localized
    ...
    func playingData(isPlaying: Bool) {
    ...
    func littleness() {
        ...
        do {
            ...
            let url = ProduceActionReactiveCompatible.default.distaffType(type: .Play_Audio_Wave)
            ...
            printLog(message: (String(noti_sendKey.prefix(6)) + "on er" + String(dataMaleTitle)))
        }
    }
}
