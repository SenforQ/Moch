...
fileprivate let app_movementText:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "btn_me_edit" :*/
fileprivate let dataMatchMessage:String = "user height var class superbtn_me"
fileprivate let notiErrorData:String = "other container pop height_edit"
...
class DetailViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_movementText.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var editImag: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.atomicCount85(name: (String(dataMatchMessage.suffix(6)) + String(notiErrorData.suffix(5)))))
...
extension DetailViewCell {
    ...
    func lineClick(titile: String, row: Int, isLast: Bool) {
    ...
    func restIn() {
        ...
        titleBLB.font = UIFont.photographicEquipment(type: .Medium, fontSize: 15)
        //: detailLB.font = UIFont.pingfangFont(type: .Medium, fontSize: 15)
        detailLB.font = UIFont.photographicEquipment(type: .Medium, fontSize: 15)
        //: editImag.isHidden = false
        editImag.isHidden = false
