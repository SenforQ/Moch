...
fileprivate let data_pathText:[UInt8] = [0xc9,0xce,0xc9,0xd4,0x88,0xc3,0xcf,0xc4,0xc5,0xd2,0x9a,0x89,0x80,0xc8,0xc1,0xd3,0x80,0xce,0xcf,0xd4,0x80,0xc2,0xc5,0xc5,0xce,0x80,0xc9,0xcd,0xd0,0xcc,0xc5,0xcd,0xc5,0xce,0xd4,0xc5,0xc4]

/*: "Add" :*/
fileprivate let show_firstKey:String = "from matchAdd"

/*: "btn_me_edit" :*/
fileprivate let noti_viewKey:[Character] = ["b"]
fileprivate let main_normalPath:String = "equal iftn_me"

/*: "Program" :*/
fileprivate let appPositionLabelIfId:[Character] = ["P","r","o","g","r","a","m"]
...
class VideoHeaderCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: data_pathText.map{$0^160}, encoding: .utf8)!)
    }
    ...
    private lazy var tipsLab: UILabel = {
        ...
        lb.text = (String(show_firstKey.suffix(3))).localized
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.atomicCount85(name: (String(noti_viewKey) + String(main_normalPath.suffix(5)) + "_edit")))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension VideoHeaderCell {
    //: func setViewData(title: String, icon: String) {
    func transmitter(title: String, icon: String) {
        //: iconImg.image = UIImage.BundleImageNamed(name: icon)
        iconImg.image = UIImage.atomicCount85(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(appPositionLabelIfId)) {
    ...
    func up() {
        ...
        backBtn.hauntWithoutRadii(width: constExplainViewMsg - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}
