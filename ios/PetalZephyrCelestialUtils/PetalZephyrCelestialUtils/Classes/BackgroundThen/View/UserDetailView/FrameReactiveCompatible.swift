...
fileprivate let app_pushKey:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_gift_placeholder" :*/
fileprivate let kPathMsg:[Character] = ["i","c","o","n","_","g","i","f","t","_","p","l","a","c","e","h","o","l","d","e","r"]

/*: "Gift" :*/
fileprivate let noti_giftShareMessage:String = "out type toolGift"

/*: "x%ld" :*/
fileprivate let data_statusUrl:String = "else guard labx%ld"
...
class FrameReactiveCompatible: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: app_pushKey.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .showViewCreate(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.atomicCount85(name: (String(kPathMsg)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(noti_giftShareMessage.suffix(4))).localized
...
extension FrameReactiveCompatible {
    ...
    func placeAll(giftModel: BuildTransformable, _ isNewProfile: Bool) {
        //: giftImgView.setUrlImage(urlStr: giftModel.img)
        giftImgView.viewFinish(urlStr: giftModel.img)
