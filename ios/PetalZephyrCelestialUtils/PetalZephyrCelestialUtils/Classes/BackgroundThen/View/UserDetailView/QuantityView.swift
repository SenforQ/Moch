...
fileprivate let const_toNoVarPath:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Gifts received" :*/
fileprivate let kTextMessage:[Character] = ["G","i","f","t","s"," ","r","e","c","e","i","v","e","d"]
...
class QuantityView: UITableViewCell {
    ...
    var giftsDataArray: [BuildTransformable] = [] {
        //: didSet {
        didSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: const_toNoVarPath.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(kTextMessage)).localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(FrameReactiveCompatible.self, forCellWithReuseIdentifier: FrameReactiveCompatible.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension QuantityView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: FrameReactiveCompatible.className(), for: indexPath) as! FrameReactiveCompatible
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: BuildTransformable = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.placeAll(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }
