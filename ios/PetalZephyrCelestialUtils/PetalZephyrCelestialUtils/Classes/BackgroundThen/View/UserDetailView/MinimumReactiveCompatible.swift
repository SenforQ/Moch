...
// __CLOSE_PRINT__
//
//  MinimumReactiveCompatible.swift
//  AbroadTalking
//
...
protocol LineObjectProtocol: NSObjectProtocol {
...
class MinimumReactiveCompatible: UICollectionViewFlowLayout {
    //: var delegate: TalkingTagCollectionFlowLayoutDelegate?
    var delegate: LineObjectProtocol?
    ...
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        for i in 1..<attributes.count {
            ...
            if i == attributes.count-1 {
                ...
                self.delegate?.peculiarity(layoutH: curAttr.frame.maxY)
            }
        }
