...
/*: "Face verification" :*/
fileprivate let constSectionButtonMsg:String = "self format userFace "
fileprivate let show_toValue:String = "fidata"
...
class AddRecognizerDelegate: TailRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        title = (String(constSectionButtonMsg.suffix(5)) + "veri" + show_toValue.replacingOccurrences(of: "data", with: "ca") + "tion").localized
        //: self.createUI()
        self.send()
    ...
    lazy var mainView: InfoNameThen = {
        //: let view = TalkingVerificationExampleView()
        let view = InfoNameThen()
        //: return view
        return view
        //: }()
    }()
...
extension AddRecognizerDelegate: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = InexpensivenessViewController(photoImage: photo)
...
extension AddRecognizerDelegate {
    ...
    func send() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            LengthPermissionTool.paneOfGlass(true) { isOpen in
