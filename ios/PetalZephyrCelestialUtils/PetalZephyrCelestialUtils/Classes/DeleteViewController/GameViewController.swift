...
/*: "Game Center" :*/
fileprivate let userCollectionHighImageId:[Character] = ["G","a","m","e"," ","C","e","n","t"]
fileprivate let kEqualPath:String = "showr"

/*: "You've got no list yet." :*/
fileprivate let show_transportValue:String = "You\'ve"
fileprivate let userMakePath:String = "self liveno l"
fileprivate let k_edgeMessage:[Character] = ["t","."]

/*: "list" :*/
fileprivate let appVoiceRandomKey:String = "lpremiumt"
...
class GameViewController: TailRecognizerDelegate {
    //: override func viewDidLoad() {
    override func viewDidLoad() {
        //: super.viewDidLoad()
        super.viewDidLoad()
        //: self.title = "Game Center".localized
        self.title = (String(userCollectionHighImageId) + kEqualPath.replacingOccurrences(of: "show", with: "e")).localized
        //: setupSubviews()
        example()
    ...
    private lazy var emptyView: EmptyView = {
        ...
        style.TipsTitle = (show_transportValue + " got " + String(userMakePath.suffix(4)) + "ist ye" + String(k_edgeMessage)).localized
...
extension GameViewController {
    ...
    private func imageEqual() {
        ...
        ValueThen.someone(category: 1) { [weak self] _, result, _ in
            //: ProgressHUD.dismiss()
            ...
            json[(appVoiceRandomKey.replacingOccurrences(of: "premium", with: "is"))].arrayObject?.forEach { dict in
...
extension GameViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.nameReloadModelViewColor(model: dataArr[indexPath.row], nameColor: .towardOf())
        //: return cell
        return cell
    }
