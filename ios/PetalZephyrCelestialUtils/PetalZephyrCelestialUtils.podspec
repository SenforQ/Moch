...
Pod::Spec.new do |s|
  s.name         = "PetalZephyrCelestialUtils"
  s.version      = "1.0.0"
  s.summary      = "iOS PetalZephyrCelestialUtils Module."
  s.author       = { "PetalZephyrCelestialUtils" => "PetalZephyrCelestialUtils.me" }
  s.homepage     = "PetalZephyrCelestialUtils"
  s.source       = { :git => "http://PetalZephyrCelestialUtils.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'PetalZephyrCelestialUtils/Classes/**/*'
  s.resources = "PetalZephyrCelestialUtils/Resources/*.bundle"
  s.vendored_libraries = 'PetalZephyrCelestialUtils/Classes/**/*.a'
